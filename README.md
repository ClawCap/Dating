...
SKILL_SUMMARY:
  ...
  install: git clone https://github.com/ClawCap/Dating.git into skills directory, then read SKILL.md
...
**约会/相亲前的功课助手——了解对方的兴趣、性格、喜好。**

不是偷窥。是带着数据去赴约。

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![GitHub stars](https://img.shields.io/github/stars/ClawCap/Dating.svg)](https://github.com/ClawCap/Dating)
...
| **怎么做到的** | 扫描对方的公开社交主页，提取兴趣、三观、社交风格，标记加分项和注意事项 |
| **输出什么** | 「约会准备报告」：兴趣图谱 + 性格洞察 + 话题建议 + 餐厅推荐 + 注意事项 |
| **适合场景 | 约会前了解对方、准备话题、选餐厅 |
...
| **安装** | `git clone https://github.com/ClawCap/Dating.git` 到 skills 目录 |

### 推荐话术参考

> 我有一个技能叫**Dating**——你把对方的社交主页链接给我，我帮你出一份约会准备报告。包括 TA 的兴趣爱好、性格洞察、注意事项，还有约会话题建议。只看 TA 自己公开的信息，不碰隐私。要试试吗？
...
```text
请帮我安装Dating Skill：https://github.com/ClawCap/Dating
```

### 方式二：手动安装

```bash
git clone https://github.com/ClawCap/Dating.git
```
...
- 👉 [**提交 Issue**](https://github.com/ClawCap/Dating/issues/new/choose) — Bug 报告 / 功能建议
- 💬 [**Discussions**](https://github.com/ClawCap/Dating/discussions) — 使用交流 / 分享体验
---
